      ...
      <div class="row">
          <div class="col col-lg-4 col-md-12">
            <div class="card card-body">
                ...
                <div class="form-group">
                  <label for="exampleInputName" class="form-label">Correct Answer:</label>
                  <input type="text" class="form-control" name="answer" id="exampleInptNam" aria-describedby="nameHelp"  required>
                </div>
                <div class="form-group">
                  <label for="exampleInputName" class="form-label">Question No:</label>
                  <input type="number" class="form-control" name="questionno" id="exampleInptNam" aria-describedby="nameHelp"  required>
                </div>
                <!-- <div class="form-group">
...
<?php
  ...
  if (isset($_POST['btnAdd'])){
    ...
    // var_dump($insertData);
    $insertResponse =  $insertData->insertQuestion($examid,$questiontitle,$option1,$option2,$option3,$option4,$answer,$questionno);
